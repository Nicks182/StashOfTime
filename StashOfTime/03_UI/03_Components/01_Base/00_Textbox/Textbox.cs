...
namespace ST_UI.Component
{
    ...
    {
        public ST_HTMLObject _Textbox(HasH_Control_Info P_CompInfo)
        {
            return ST_HTMLObject.Create(HasH_Tag.Input)
                .Add_Attribute(HasH_Attribute.Id            , P_CompInfo.GuiId)
                .Add_Attribute(HasH_Attribute.ValidStatus   , P_CompInfo.ValidStatus.ToString())
                .Add_Attribute(HasH_Attribute.Type          , HasH_Types.Text)
        ...
        private string _Textbox_Changed_Event(HasH_Control_Info P_HasH_Control_Info)
        {
            return
